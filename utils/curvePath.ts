...
/**
 * Builds a smooth SVG path string through the given points using a
 * Catmull-Rom to cubic-bezier conversion. Produces gentle, editorial
 * curves rather than sharp map-like polylines.
 */
